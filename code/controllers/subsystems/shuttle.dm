...
/datum/controller/subsystem/shuttles/fire()
	//process ferry shuttles
	for (var/datum/shuttle/autodock/shuttle in process_shuttles)
		if (shuttle.process_state)
			shuttle.process()

/datum/controller/subsystem/shuttles/proc/register_landmark(var/shuttle_landmark_tag, var/obj/effect/shuttle_landmark/shuttle_landmark)
...
/datum/controller/subsystem/shuttles/proc/initialise_shuttle(var/shuttle_type)
	var/datum/shuttle/shuttle = shuttle_type
