...
/client/proc/receive_looc(var/client/C, var/commkey, var/message, var/prefix)
	...
	if(prefix)
		prefix = "\[[prefix]\] "
	return "<span class='ooc'><span class='looc'><b>LOOC:</b><span class='prefix'>[prefix]</span><EM>[display_name][admin_stuff]:</EM> <span class='message linkify'>[message]</span></span></span>"
