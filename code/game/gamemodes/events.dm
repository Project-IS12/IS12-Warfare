	...
	for(var/mob/living/silicon/ai/M in GLOB.living_mob_list_)
		if(M.stat != 2 && M.see_in_dark != 0)
			...
			switch(rand(1,14))
				if(1)
					to_chat(M, "<br>")
					to_chat(M, SPAN_DANGER("THERE ARE [amount] [who2] ON THE [uppertext(station_name())]...LAWS UPDATED"))
					to_chat(M, "<br>")
				...
				if(3)
					to_chat(M, "<br>")
					to_chat(M, SPAN_DANGER("THE ESCAPE-SHUTTLE CANNOT BE CALLED BECAUSE OF [who2] ON THE [uppertext(station_name())]...LAWS UPDATED"))
					to_chat(M, "<br>")
				...
				if(6)
					to_chat(M, "<br>")
					to_chat(M, SPAN_DANGER("THE [uppertext(station_name())] IS BUILT FOR [who2]...LAWS UPDATED"))
					to_chat(M, "<br>")
				...
				if(14)
					to_chat(M, "<br>")
					to_chat(M, SPAN_DANGER("THE [uppertext(station_name())] IS [who2pref] [who2]...LAWS UPDATED"))
					to_chat(M, "<br>")
