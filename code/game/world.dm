/var/server_name = "IS12: SIEGE (Unofficial Warfare)"
/var/game_id = null
/var/list/warfare_taglines = list("IS12: SIEGE (Unofficial Warfare) Human vs Human Attack/Defense")// list("It's Getting Cold Out There", "New Guns", "New Classes", "Cold", "Winter", "Frozen Solid", "Frozen Trench Pizza", "Warcrime Simulator", "Your Heart Has Stopped", )
