...
/obj/structure/closet/secure_closet/captains/WillContain()
	return list(
		new/datum/atom_creator/weighted(list(/obj/item/weapon/storage/backpack/captain, /obj/item/weapon/storage/backpack/satchel/satchel_cap)),
...
/obj/structure/closet/secure_closet/hos/WillContain()
	return list(
		new/datum/atom_creator/weighted(list(/obj/item/weapon/storage/backpack/security, /obj/item/weapon/storage/backpack/satchel/satchel_sec)),
		...
		/obj/item/device/flash,
		/obj/item/weapon/material/sword,//Broadsword, the most powerful melee weapon a HoS could ask for.
		/obj/item/weapon/melee/classic_baton,///obj/item/weapon/melee/baton/loaded,
		///obj/item/weapon/gun/energy/gun,
