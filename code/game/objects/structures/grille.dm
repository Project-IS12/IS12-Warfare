...
/obj/structure/grille/floorgrille
	name = "floor grille"
	density = FALSE
...
/obj/structure/grille/floorgrille/Crossed(atom/movable/O)
	..()
	if(isobserver(O))
		return
	if(!destroyed)
...
/obj/structure/grille/attackby(obj/item/W as obj, mob/living/user as mob)
	if(isWirecutter(W))
		if(!shock(user, 100))
