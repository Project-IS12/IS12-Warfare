...
/obj/item/weapon/gun/proc/can_shoot() //This is just an abstract check to stop us from attempting to shoot an empty gun instead of doing a melee attack.
	return TRUE
...
/obj/item/weapon/gun/proc/add_bayonet()
	var/image/I =  image('icons/obj/gun.dmi', "bayonett")
	I.pixel_x += 5
	src.overlays += I


/obj/item/weapon/gun/proc/unload_ammo(mob/user, var/allow_dump=1)
	return
