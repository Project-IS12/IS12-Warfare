...
/obj/item/weapon/reagent_containers/hypospray/autoinjector/revive
...
/obj/item/weapon/reagent_containers/hypospray/autoinjector/blood
	name = "blood injector"
...
/obj/item/weapon/reagent_containers/hypospray/autoinjector/blood/New()
	..()
	if(blood_type)
...
/obj/item/weapon/reagent_containers/hypospray/autoinjector/morphine/update_icon()
	if(reagents.total_volume > 0)
		icon_state = "syrette_closed"
	else
...
/obj/item/weapon/reagent_containers/glass/ampule/attackby(obj/item/weapon/W, mob/user as mob)
	if(istype(W, /obj/item/weapon/reagent_containers/hypospray/autoinjector))
		var/obj/item/weapon/reagent_containers/hypospray/autoinjector/A = W
		if(src.reagents)
