...
/datum/reagent/proc/addiction_act_stage2(var/mob/living/carbon/M, var/datum/reagent/R)
	...
	if(prob(10))
		var/message = pick("I could use some [name] rigth now!","I am feeling a bit stressed, sure could use some [name]!","I could use some [name] rigth now!")
		to_chat(M, "<span class='notice'>[message]</span>")
...
/datum/reagent/proc/addiction_act_stage3(var/mob/living/carbon/M, var/datum/reagent/R)
	...
	clear_events(R.name, M)
	if(prob(10))
		var/message = pick("I really could use some [name] rigth now!","I am feeling a bit stressed, sure could use some [name]!","I should use some [name]")
		to_chat(M, "<span class='notice'>[message]</span>")
...
/datum/reagent/proc/addiction_act_stage5(var/mob/living/carbon/M, var/datum/reagent/R)
	...
	clear_events(R.name, M)
	if(prob(10))
		var/message = pick("I need to use some [name] rigth now!","I am stressed, I need to use some [name] RIGTH NOW!","I REALLY NEED SOME [name]")
		to_chat(M, "<span class='notice'>[message]</span>")
