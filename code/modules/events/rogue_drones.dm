...
/datum/event/rogue_drone/announce()
	...
	threat_announcement.Announce(msg, "[station_name()] Sensor Array")
...
/datum/event/rogue_drone/end()
	...
	if(num_recovered > drones_list.len * 0.75)
		threat_announcement.Announce("Be advised: sensors indicate the unidentified drone swarm has left the immediate proximity of the [station_name()].", "[station_name()] Sensor Array")
	else
		threat_announcement.Announce("Be advised: sensors indicate the unidentified drone swarm has left the immediate proximity of the [station_name()].", "[station_name()] Sensor Array")
