...
/proc/spawn_dynamic_event()
	...
	possibleEvents[/datum/event/solar_storm] = 100

	if(!spacevines_spawned)
		possibleEvents[/datum/event/spacevine] = 10 + 5 * active_with_role["Engineer"]
	possibleEvents[/datum/event/meteor_wave] = 50 * active_with_role["Engineer"]
	possibleEvents[/datum/event/dust] = 50 * active_with_role["Engineer"]
