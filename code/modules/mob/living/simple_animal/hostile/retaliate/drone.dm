...
/mob/living/simple_animal/hostile/retaliate/malf_drone
	...
	maxHealth = 300
	speed = 8
	projectiletype = /obj/item/projectile/energy/laser // /obj/item/projectile/beam/drone
...
/mob/living/simple_animal/hostile/retaliate/malf_drone/Initialize()
	. = ..()
	if(prob(5))
		projectiletype = /obj/item/projectile/energy/laser // /obj/item/projectile/beam/pulse/drone
	...
	if(health / maxHealth > 0.9)
		...
		if(!disabled)
			if(prob(50))
				...
				src.visible_message(SPAN_NOTICE("\icon[src] [src] suddenly lies still and quiet."))
