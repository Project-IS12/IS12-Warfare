...
/mob/living/simple_animal/hostile/retaliate/goat/king/Retaliate()
	..()
	if(stat == CONSCIOUS)
		visible_message(SPAN_WARNING("[src] bellows indignantly, with a judgemental gleam in their eye."))

/mob/living/simple_animal/hostile/retaliate/goat/king/death()
	..()
	visible_message(SPAN_WARNING("\The [src] shrieks as the seal on their power breaks and his wool peels off!"))
