...
/material/proc/build_rod_product(var/mob/living/carbon/human/user, var/obj/item/stack/used_stack, var/obj/item/stack/target_stack)
	...
	if(user.statscheck(skills = user.SKILL_LEVEL(engineering)) >= SUCCESS)
		...
		to_chat(user, SPAN_WARNING("I have botched bulding what I'm building."))
...
/material/proc/build_wired_product(var/mob/living/carbon/human/user, var/obj/item/stack/used_stack, var/obj/item/stack/target_stack)
	...
	if(user.statscheck(skills = user.SKILL_LEVEL(engineering)) >= SUCCESS)
		...
		to_chat(user, SPAN_WARNING("I have botched adding the wires."))
...
/material/glass/build_windows(var/mob/living/carbon/human/user, var/obj/item/stack/used_stack)
	...
	if(user.statscheck(skills = user.SKILL_LEVEL(engineering)) >= SUCCESS)
		...
		to_chat(user, SPAN_WARNING("I have failed to build a window."))
