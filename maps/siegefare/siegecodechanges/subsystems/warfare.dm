...
/datum/team
	...
	var/left = 999 //Number of reinforcements both sides have.!@!SIEGEFARE!@!
...
/datum/controller/subsystem/warfare/proc/declare_completion()
	...
	//KOTH shit
		...
		assign_victory(TRUE)
	//else if(warfare.battle_time >= 10)
		//to_world("<FONT size = 3><B>[BLUE_TEAM] Major Victory</B></FONT>")
		//to_world("<FONT size = 3><B>\The [BLUE_TEAM] managed to successfuly holdout against \the [RED_TEAM]'s waves!</B>'")
		//assign_victory(TRUE)
